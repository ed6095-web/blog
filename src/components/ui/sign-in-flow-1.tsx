  ...
  return (
    <a href={href} className={`group relative inline-flex overflow-hidden h-5 ${textSizeClass}`}>
      <div className="flex flex-col transition-transform duration-300 ease-out transform group-hover:-translate-y-1/2">
        <span className={`${defaultTextColor} h-5 leading-5`}>{children}</span>
        <span className={`${hoverTextColor} h-5 leading-5`}>{children}</span>
      </div>
    </a>
  );
};
...
function MiniNavbar() {
  ...
  const logoElement = (
    <div className="flex items-center justify-center">
      <img src="/wavvy-logo.png" alt="Wavvy Logo" className="h-8 sm:h-10 w-auto object-contain" />
    </div>
  );
  ...
  const loginButtonElement = (
    <Link href="/auth/login" className="px-4 py-2 sm:px-3 text-xs sm:text-sm border border-[#333] bg-[rgba(31,31,31,0.62)] text-gray-300 rounded-full hover:border-white/50 hover:text-white transition-colors duration-200 w-full sm:w-auto text-center block">
      LogIn
    </Link>
  );
  ...
  const signupButtonElement = (
    <div className="relative group w-full sm:w-auto">
       ...
       <Link href="/auth/signup" className="relative block z-10 px-4 py-2 sm:px-3 text-xs sm:text-sm font-semibold text-black bg-gradient-to-br from-gray-100 to-gray-300 rounded-full hover:from-gray-200 hover:to-gray-400 transition-all duration-200 w-full sm:w-auto text-center">
         Signup
       </Link>
    </div>
  );
                ...
                {step === "email" ? (
                  ...
                  >
                    <div className="space-y-4 flex flex-col items-center">
                      <img src="/wavvy-logo.png" alt="Wavvy" className="w-16 h-16 object-contain mb-2" />
                      <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white">Welcome Back</h1>
                      <p className="text-[1.8rem] text-white/70 font-light">Sign in to Wavvy</p>
                    </div>
              ...
              <AnimatePresence mode="wait">
                {step === "details" ? (
                  ...
                  >
                    <div className="space-y-4 flex flex-col items-center">
                      <img src="/wavvy-logo.png" alt="Wavvy" className="w-16 h-16 object-contain mb-2" />
                      <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white">Join Wavvy</h1>
                  ...
                  >
                    <div className="space-y-1">
                      <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white">Secure Account</h1>
                      <p className="text-[1.25rem] text-white/50 font-light">{email}</p>
                    </div>
                  ...
                  >
                    <div className="space-y-1">
                      <h1 className="text-[2.5rem] font-bold leading-[1.1] tracking-tight text-white">You're in!</h1>
                      <p className="text-[1.25rem] text-white/50 font-light">Welcome to Wavvy, {name}</p>
                    </div>
